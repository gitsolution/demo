                        ...
                        <ul>
                          ...
                          <li class="text-muted menu-title"></li>
                            ...
                            <li <?php echo e(Request::is('dashboard')? 'class=active' :''); ?>>
                                    <a class="" href="<?php echo e(url('/dashboard')); ?>"><i class="fa fa-area-chart"></i> Dashboard</a>
                            </li>

                            <li <?php echo e(Request::is('embarques')? 'class=active' :''); ?>>
                                    <a class="" href="<?php echo e(url('/embarques')); ?>"><i class="fa fa-paper-plane"></i> Embarques</a>
                            </li>


                         

                            <li <?php echo e(Request::is('rastreo')? 'class=active' :''); ?>>
                                    <a class="" href="<?php echo e(url('/rastreo')); ?>"><i class="fa fa-map-marker"></i> Rastreo</a>
                            </li>


                            <li <?php echo e(Request::is('empresas')? 'class=active' :''); ?>>
                                    <a class="" href="<?php echo e(url('/empresas')); ?>"><i class="fa fa-building-o"></i> Empresas</a>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li <?php echo e(Request::is('perfiles')? 'class=active' :''); ?>>
                                    <a class="" href="<?php echo e(url('/perfiles')); ?>">Perfiles</a>
                                    </li>


                                    <li <?php echo e(Request::is('usuarios')? 'class=active' :''); ?>>
                                        <a class="" href="<?php echo e(url('/usuarios')); ?>">Usuarios</a>
                                    </li>

                                    <li <?php echo e(Request::is('ubicaciones')? 'class=active' :''); ?>>
                                        <a class="" href="<?php echo e(url('/ubicaciones')); ?>">Ubicaciones</a>
                                    </li>
